    ...
    if (window.portfoyTab === 'bilgiler') {
        tabContentHtml = `
            <div id="portfoy-bilgiler" class="portfoy-tab-content" style="display: flex; flex-direction: column; gap: 1rem; margin-bottom: 0;">
                <div class="flex-row" style="align-items: flex-start; gap: 2rem; flex-wrap: wrap;">
                    <div class="table-container glass" style="margin-bottom: 0; width: max-content; overflow-x: auto; padding: 0.5rem;">
                    ...
                    <div class="glass" style="width: 380px; height: 380px; display: flex; justify-content: center; align-items: center; padding: 1rem;">
        ...
        tabContentHtml = `
            <div class="glass" style="display: flex; flex-direction: column; width: 100%; min-height: 350px; margin-bottom: 0;">
                <div class="table-header" style="padding: 1rem 1rem 0.5rem 1rem; border-bottom: 1px solid var(--surface-border);">Günlük Portföy Değişimi</div>
