...
code = code.replace(/<button type="submit" class="btn btn-danger"([^>]+)>Parolayı Güncelle<\/button>\s*<\/form>\s*<\/div>\s*<\/div>\s*`;/m,
    `<button type="submit" class="btn btn-danger"$1>Parolayı Güncelle</button>
                </form>
